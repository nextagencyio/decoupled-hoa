...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Lakewood Heights HOA. We\'d love to hear from you about community matters, dues, or architectural requests.',
  keywords: ['Contact Lakewood Heights HOA', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about community matters, dues, or architectural requests? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">board@lakewoodheightshoa.com</p>
                    <p className="text-gray-600">support@lakewoodheightshoa.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 012-3415</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      1 Lakewood Heights Clubhouse<br />
                      Community Center Drive<br />
                      Lakewood Heights, FL 33458
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      Clubhouse: Daily 6:00 AM - 10:00 PM
                    </p>
                  </div>
                </div>
              </div>
